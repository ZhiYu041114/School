...
<div class="register-container">
    ...
    <form action="${pageContext.request.contextPath}/register" method="post">
        ...
        <div class="captcha-container">
            ...
            <img src="${pageContext.request.contextPath}/register" style="width: 50px;height: 30px" alt="Captcha" onclick="this.src='${pageContext.request.contextPath}/register?' + new Date().getTime()">
